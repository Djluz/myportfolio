        ...
        <section className="min-h-screen" id="">
          <nav className='flex justify-between py-10 mb-12 dark:text-white'>
            ...
            <ul className='flex items-center'>
              ...
              <li>
                <a className='px-5 py-2 ml-5 text-white align-middle rounded-lg shadow-lg bg-gradient-to-r from-cyan-500 to-teal-500 hover:shadow-gray-500 hover:text-black' download href={CV} >
                Download CV
                </a>
              </li>
            </ul>
